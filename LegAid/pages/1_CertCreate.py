...
st.markdown(
    """
    <style>
    div[data-testid='stButton'] button[id^='apply_'] {
        background-color:#90ee90 !important;
        color:black !important;
    }
    div[data-testid='stButton'] button[id^='keep_'] {
            ...
            if f"improved_{i}" in st.session_state:
                ...
                with right:
                    ...
                    c1.markdown(
                        f"""
                        <style>
                        div[data-testid='stButton'] button#apply_{i} {{
                            background-color:#90ee90 !important;
                            color:black !important;
                        }}
                        </style>
                    ...
                    c2.markdown(
                        f"""
                        <style>
                        div[data-testid='stButton'] button#keep_{i} {{
                            background-color:#f8d7da !important;
                            color:black !important;
                        }}
                        </style>
...
def generate_pdf_certificates(entries):
    ...
    for i, entry in enumerate(entries):
        ...
        if title_provided:
            ...
            title_y = text_start_y - 0.55 * inch
